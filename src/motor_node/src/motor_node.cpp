...
void PrintUsage()
{
        cout << "Usage: motor_node_node -h -n 1 -d deviceName -s protocolStackName -i interfaceName -p portName -b baudrate" << endl;
}
...
void SetDefaultParameters()
{
        //USB
        g_usNodeId = 1;
        g_deviceName = "EPOS"; //EPOS
        g_protocolStackName = "MAXON_RS232"; //MAXON_RS232
        g_interfaceName = "RS232"; //RS232
        g_portName = "/dev/ttyS0"; // /dev/ttyS1
        g_baudrate = 115200; //115200
}
